...
/*
creates a new stochastic task from an array of doubles
...
/*
frees the memory of a stochastic taskset BUT NOT THE MEMORY OF ITS TASKS.
...
*/
int add_task (stochastic_taskset * ts, stochastic_task task);
/*
